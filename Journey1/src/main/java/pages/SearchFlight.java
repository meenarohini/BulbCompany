...
public class SearchFlight extends BasePage{
	...
	//multicity date selection
	

	public String generateMonthDateXpath_Multicity(String date){
		String genericSourceXpath ="//div[@class='cal-body BE_flight_origin_date_1']//div[2]//td[contains(@title,'May') and contains(text(),'"+"<DATE>"+"')]";
		String monthDateXpath= genericSourceXpath.replace ("<DATE>", date);
		return monthDateXpath;
	}
	public void multicitySelectDepartDate(String month ){
	...
	public String multicitySelectDestinationDate(String date){
		String genericSourceXpath ="//div[@class='cal-body BE_flight_origin_date_2']//div[2]//td[contains(@title,'May') and contains(text(),'"+"<DATE>"+"')]";
		String monthDateXpath= genericSourceXpath.replace ("<DATE>", date);
		return monthDateXpath;
	}
